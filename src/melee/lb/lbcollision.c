...
extern char un_80400080[];

/// .sdata: the full 24-entry hitbox/hurtbox color set, in binary-proven
/// target order and values (target exports all of them, idiom 139).
...
GXColor lbColl_804D36C4 = { 0x00, 0xFF, 0xFF, 0x80 };
GXColor lbColl_804D36C8 = { 0x00, 0x80, 0x80, 0x80 };
GXColor lbColl_804D36CC = { 0x00, 0xFF, 0x80, 0x80 };
GXColor lbColl_804D36D0 = { 0x00, 0x80, 0x40, 0x80 };
GXColor lbColl_804D36D4 = { 0x00, 0x80, 0xFF, 0x80 };
GXColor lbColl_804D36D8 = { 0x00, 0x40, 0x80, 0x80 };
GXColor lbColl_804D36DC = { 0xFF, 0xFF, 0xFF, 0x80 };
GXColor lbColl_804D36E0 = { 0xFF, 0x80, 0x00, 0x80 };
GXColor* lbColl_804D36E4 = (GXColor*) un_80400080; /* binary-proven: the
    target relocates this slot to the un_80400080 string; its address bytes
    {80,40,00,80} double as the color read through &slot */
GXColor lbColl_804D36E8 = { 0xFF, 0xFF, 0xFF, 0x80 };
GXColor lbColl_804D36EC = { 0x80, 0x80, 0x80, 0x80 };
GXColor lbColl_804D36F0 = { 0xFF, 0xFF, 0x00, 0x80 };
GXColor lbColl_804D36F4 = { 0x80, 0x80, 0x00, 0x80 };
GXColor lbColl_804D36F8 = { 0xFF, 0x00, 0x00, 0x80 };
GXColor lbColl_804D36FC = { 0x80, 0x00, 0x00, 0x80 };
...

            {
                ...
                if (approximatelyZero(temp_f7)) {
                    ...
                    if (approximatelyZero(temp_f10)) {
                        float temp_f9 =
                            (0.5 * temp_f22 + arg5_offset.y);
                        float temp_f7_2 =
                            (0.5 * temp_f23 + arg5_offset.x);
...
extern GXColor const lbColl_804D7A50;
...
/// Positioned here: the target pools this named zero AFTER the f64
/// conversion magic created by lbColl_80008D30 (idiom 146 window).
...
bool lbColl_8000A460(Fighter_x1670_t* hurt, u32 arg1)
{
    ...
    GXColor* r30 = (GXColor*) &lbColl_804D36E4;
