...
static inline void if_802F7C30_inline(void** base, s32 idx, void** entry, u8 v, s32 arg2)
{
    base[idx + 1] = fn_802F77F8(*++entry, v, arg2);
    if (base[idx + 1] != NULL) {
        HSD_GObj_SetupProc(*entry, (HSD_GObjEvent) fn_802F75D4, 0x11);
    }
}
...
void if_802F7C30(s32 slot)
{
    ...
    if (ret == -2) {
        ...
        idx = (u8) slot << 1;
        entry = base + idx;
        if_802F7C30_inline(base, idx, entry, slot, 1);
    }
}
